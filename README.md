...
[![Live Deployment](https://img.shields.io/badge/Deployment-Live%20Preview-8b5cf6?style=for-the-badge)](/preview/prod-custom-chart-5ca927/)
...
- **پیوند دسترسی زنده (Live Preview):** [/preview/prod-custom-chart-5ca927/](/preview/prod-custom-chart-5ca927/)
...
```bash
# ۱. کلون ریپازیتوری
git clone https://github.com/98H/nexus-custom-chart.git
cd nexus-custom-chart
...
- **تاریخ آخرین همگام‌سازی:** 2026-09-19 19:06:06 UTC